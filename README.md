...
```bash
git clone https://github.com/Sk-Traitor/ZOREX-WiFi-Cracker.git
cd ZOREX
...
sudo apt update
sudo apt install -y aircrack-ng hashcat reaver hcxdumptool hostapd dnsmasq php
pip3 install netifaces

# Run
sudo python3 zorex.py

THIS TOOL IS FOR EDUCATIONAL AND AUTHORIZED TESTING ONLY.

By using ZOREX, you agree that:
- You will only test networks you own or have written permission to test
- You will not use this tool for illegal activities
- The author is not responsible for any misuse

Unauthorized network access is a crime. Use responsibly.
Author 
SHEBY - Security Researcher
